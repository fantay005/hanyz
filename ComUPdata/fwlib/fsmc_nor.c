...
//关于字库下载的变量============================
// extern u8  recive_zk_data_flg;  //收到了1个字库的字符
// extern u16 zk_data_16bit;       //收到了4个字库的字符,组成一个halfword,然后往Flash里写
// extern u8  recv_com1_data;      //收到的字符
// extern u32 tt;                  //接收字符计数
//==============================================
...
//==============================================================================
//时间：Chen Yangde 2009-5-4
//希望：做STM32F103的字库下载程序
//状态：可以从串口接收总字库，然后写到sst39vf3201b里，
// void receive_zk_write_flash(void)    	//从串口接收字库，然后写到FLASH里
// {
//    
// }
//==============================================================================
